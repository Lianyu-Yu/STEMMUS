...
global ISFT T_CRIT SAVEhh TT_CRIT T0 TT T MN EPCT h
if NBCh==1
    CnvrgnCHK
elseif NBCh==3
    if NBChh==2           %------------------------> NBCh is equal to 3. Which type of BC was used on last time step?
        if hh(NN)<= DSTOR %hh(NN)------------------------> NBChh is equal to 2. Check that calculated surface matric head is not unrealistic.
